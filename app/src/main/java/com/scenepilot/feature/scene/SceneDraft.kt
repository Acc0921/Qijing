...
data class SceneDraft(
    ...
    fun validate(): List<String> = buildList {
        ...
        if (swappinessValue == null || swappinessValue !in 0..200) add("swappiness 必须在 0..200")
    ...
    fun toProfile(): SceneProfile {
        ...
        return SceneProfile(id = id, name = name, packageNames = packages,
            ...
            memory = MemoryIntent(zramEnabled, zramSizeMiB.toLongOrNull()?.times(1024 * 1024), swappiness = swappiness.toInt()), enabled = true)
    }
}
